...
warriors_data <- data.frame(warriors_list, stringsAsFactors = FALSE)
...
cbind(Player, Position, Salary, Points, PPG, Rookie)
```
...
```{r}
length(dat[dat[, "college"] == "University of California", 'player'])
```
